...
export const Caracteristics: Record<CaractKey, Caract> = {
  ...
  intelligence: { libelle: 'Intelligence', code: 'INT', description: 'Mental, réflexion, équilibre psychique', color: 'lagoon' },
  charisme: { libelle: 'Charisme', code: 'CHA', description: 'Présentation, hygiène, aura sociale', color: 'grape' },
